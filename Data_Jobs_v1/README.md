...
This dashboard was created for **Job Seekers** to solve a common issue: scattered information about the job market of data-related jobs. Using the real-world dataset of 2024, this dashboard provides *interactive and easy-to-use interface* to explore the *job market trends in 2024.*

## Skills Showcased

- **Data Transformation with Power Query:** 
Cleaned, shaped, and prepared the raw data for ananlysis by handling blanks, changing data types, and creating new columns.
- **Implicit Measures:** 
Formulated measures to derive key insights and KPIs like Median Yealy Salary and Job Count
